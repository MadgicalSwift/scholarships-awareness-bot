export const localisedStrings = {
  ...
  languageChangedMessage: " 🎉**Great! You’ve selected English. Let's get started!** Here's everything you need to know about the **National Means-cum-Merit Scholarship (NMMS):🌟 What is NMMS?** The NMMS Scholarship is a program for Class 8 students to support their education. If you qualify, you’ll receive **₹ 12,000 per year** ( ₹ 1000 per month ) until Class 12!",
